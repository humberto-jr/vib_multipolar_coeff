module legendre_polynomial_lib
    implicit none
!
    private :: imtqlx, r8_factorial, r8mat_print, r8mat_print_some, r8vec2_print, r8vec_linspace, r8vec_print, timestamp
!
    contains
...
end module legendre_polynomial_lib
